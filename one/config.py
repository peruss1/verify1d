# Konfiguracja weryfikacji Verify1D (ten moduł)

# Endpointy API (oficjalne hosty usługi)
...
# Uczelnie — Pennsylvania State University (kampusy)
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
...
# Parametry UTM (śledzenie kampanii) — dopisywane, gdy brak w URL
DEFAULT_UTM_PARAMS = {
    'utm_source': 'gemini',
