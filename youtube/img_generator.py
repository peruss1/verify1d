"""Generowanie PNG legitymacji — szablon Penn State LionPATH."""
import random
...
def generate_html(first_name, last_name, school_id='2565'):
    """
    HTML strony LionPATH (Penn State).

    Args:
        first_name, last_name: dane studenta
        school_id: identyfikator uczelni w systemie
...
<head>
    ...
    <style>
        ...
        body {{
            ...
            background-color: #e0e0e0; /* tło jak w przeglądarce */
            margin: 0;
            padding: 20px;
...
def generate_image(first_name, last_name, school_id='2565'):
    """
    Zrzut ekranu LionPATH jako PNG.
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.wait_for_timeout(500)  # stabilizacja stylów
        ...
        raise Exception("Zainstaluj playwright: pip install playwright && playwright install chromium")
    except Exception as e:
        raise Exception(f"Generowanie obrazu nie powiodło się: {str(e)}")
...
if __name__ == '__main__':
    ...
    print("Test generowania PNG PSU...")

    first_name = "John"
    last_name = "Smith"

    print(f"Imię i nazwisko: {first_name} {last_name}")
    print(f"PSU ID: {generate_psu_id()}")
    print(f"E-mail: {generate_psu_email(first_name, last_name)}")
    ...
    try:
        ...
        print(f"✓ PNG OK, rozmiar: {len(img_data)} bajtów")
        print("✓ Zapisano test_psu_card.png")
